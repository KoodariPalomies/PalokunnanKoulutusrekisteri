 ...
 * @author mitulint
 * @version 1.0 27.2.2021   / Alkuperäinen versio oli pelkästään Hetun tarkistusta varten
 * @version 1.1, 13.5.2021  / Lisäsin ehdotuksen kuukausista sekä tarkistuksesta
 * TODO: muokkaa tätä omaan ohjelmaan sopivaksi --> tarkistus koulutusten suoritus ja umpeutumispäivämäärille (tarkistus-aliohjelmaa muokkaamalla!)
 *
 */
